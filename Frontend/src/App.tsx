...
import { Activity, AlertCircle, Check, Clipboard, Download, FileArchive, FileCode2, FileText, LoaderCircle, Sparkles, UploadCloud, X } from "lucide-react";
import { Analysis, createSource, getAnalysis, getApiBaseUrl } from "./api";
...
function App() {
    ...
    return (
        <div className="min-h-screen bg-[#e8f1f5] text-[#d8e7ed]">
            ...
            <main className="mx-auto max-w-347.5 px-[clamp(18px,5vw,80px)] pb-14 pt-9"><div className="mb-6 flex items-end justify-between gap-4"><div><p className="mb-2 font-mono text-[10px] uppercase tracking-[1.4px] text-[#7890ab]">Espacio de trabajo / lectura asistida</p><h1 className="text-[25px] font-bold tracking-[-.8px] text-[#18334b]">Organiza la información de tus documentos</h1></div></div>
